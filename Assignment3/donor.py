...
#2 Parameters donor blood type is donor, recipient's type is recipient, and 
#pints is the number of pints that donor will give to recipient using the bank.

# Return True if the blood bank has enough pints to give 
# and remove the amount of pints used from the bank.

# Return False if either the recipient can't recieve the type
# or there's not enough blood.
